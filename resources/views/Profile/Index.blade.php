        ...
        <div class="col-xl-4">
            ...
            <div class="card">
                <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                    @if ($user->userDetail)
                    <img src="{{ asset('storage/'. $userDetail->photo) }}" alt="Profile" class="rounded-circle">
                    @else
                    <img src="{{ asset('assets/img/user-default.png') }}" alt="Profile" class="rounded-circle">
                    @endif
                        ...
                        <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                            ...
                            <form enctype="multipart/form-data" method="post" action="{{ route('profile.change-profile') }}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <textarea name="company" type="text" class="form-control" id="company" value="{{ $userDetail->company ?? '' }}"></textarea>
                                    </div>
                                </div>
