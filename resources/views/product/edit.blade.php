 ...
 <div class="row">
                ...
                <div class="mb-3">
                    ...
                    <select name="category_id" id="" class="form-control">
                        ...
                        @foreach ($categories as $category)
                            <option value="{{$edit->$category_id == $category->id?'selected':''}}" value=""{{ $category->category_name }} </option>
                        @endforeach
                    </select>
                </div>
                <div class="mb-3">
            ...
            <div class="col-sm-6">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="product_description" id="" class="form-control">{{ $edit->product_description }}
                </div>
                <div class="mb-3">
